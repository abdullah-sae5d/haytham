!(function (a, b) {
  ...
  function cu(a) {
    if (!cj[a]) {
      ...
      d.remove(),
        ("none" !== e && "" !== e) ||
          (ck ||
            ((ck = c.createElement("iframe")).frameBorder =
              ck.width =
              ck.height =
                0),
          b.appendChild(ck),
          (cl && ck.createElement) ||
            ((cl = (ck.contentWindow || ck.contentDocument).document).write(
  ...
  function bY(a) {
    return function (b, c) {
      if (("string" != typeof b && ((c = b), (b = "*")), f.isFunction(c)))
        for (
          var h, j, d = b.toLowerCase().split(bO), e = 0, g = d.length;
          e < g;
          e++
        )
          (h = d[e]),
            (j = /^\+/.test(h)) && (h = h.substr(1) || "*"),
            (a[h] = a[h] || [])[j ? "unshift" : "push"](c);
    };
  }
  function bB(a, b, c) {
    ...
    if ((((d = by(a, b)) < 0 || null == d) && (d = a.style[b]), bt.test(d)))
      return d;
  ...
  function bk(a, b) {
    ...
    1 === b.nodeType &&
      ...
      "object" === (c = b.nodeName.toLowerCase())
      ...
      return (
                  ...
                  if (g[1])
                    return (
                      ...
                      (j = m.exec(a))
                        ...
                        : (a = (
                            (j = e.buildFragment([g[1]], [k])).cacheable
                              ? e.clone(j.fragment)
                              : j.fragment
                          ).childNodes),
                      e.merge(this, a)
        ...
        e.extend({
          ...
          bindReady: function () {
            if (!A) {
              if (
                ((A = e.Callbacks("once memory")), "complete" === c.readyState)
              )
          ...
          parseXML: function (c) {
            ...
            try {
              a.DOMParser
                ? (d = new DOMParser().parseFromString(c, "text/xml"))
                : (((d = new ActiveXObject("Microsoft.XMLDOM")).async =
                    "false"),
                  d.loadXML(c));
            } catch (g) {
              d = b;
          ...
          each: function (a, c, d) {
            ...
            if (d)
              if (i) {
                for (f in a) if (!1 === c.apply(a[f], d)) break;
              } else for (; g < h && !1 !== c.apply(a[g++], d); );
            else if (i) {
              for (f in a) if (!1 === c.call(a[f], f, a[f])) break;
            } else for (; g < h && !1 !== c.call(a[g], g, a[g++]); );
            return a;
          },
          trim: G
            ? function (a) {
          ...
          map: function (a, c, d) {
            ...
            if (
              ...
              for (; i < j; i++)
                null != (f = c(a[i], i, d)) && (h[h.length] = f);
            else for (g in a) null != (f = c(a[g], g, d)) && (h[h.length] = f);
    ...
    var e,
      ...
      o = function (b, f) {
        for (
          ...
          if (!1 === c[m].apply(b, f) && a.stopOnFalse) {
            e = !0;
            break;
          }
        (j = !1),
      ...
      p = {
        add: function () {
          if (c) {
            var a = c.length;
            n(arguments),
              j ? (l = c.length) : e && !0 !== e && ((k = a), o(e[0], e[1]));
          }
          return this;
        },
        remove: function () {
        ...
        has: function (a) {
          if (c)
            for (var b = 0, d = c.length; b < d; b++) if (a === c[b]) return !0;
          return !1;
        },
        empty: function () {
          return (c = []), this;
        ...
        lock: function () {
          return (d = b), (!e || !0 === e) && p.disable(), this;
        },
        locked: function () {
          return !d;
        },
  ...
  f.extend({
    ...
    (f.support = (function () {
      ...
      if (
        ...
        return {};
      (h = (g = c.createElement("select")).appendChild(
      ...
      if (
        ...
        p.appendChild(i),
        (j = c.createDocumentFragment()).appendChild(p.lastChild),
      ...
      return (
        ...
        f(function () {
          ...
          !u ||
            ((s = (t = "padding:0;margin:0;border:") + "0;visibility:hidden;"),
            (q =
              "<div " +
              (n =
                "style='" +
            ...
            ((d = c.createElement("div")).style.cssText =
              s + "width:0;height:0;position:static;top:0;margin-top:1px"),
            ...
            a.getComputedStyle &&
              ((p.innerHTML = ""),
              ((l = c.createElement("div")).style.width = "0"),
            ...
            (j.doesNotIncludeMarginInBodyOffset = 1 !== u.offsetTop),
            a.getComputedStyle &&
              ((p.style.marginTop = "1%"),
              (b.pixelMargin =
                "1%" !==
                (a.getComputedStyle(p, null) || { marginTop: 0 }).marginTop)),
            void 0 !== d.style.zoom && (d.style.zoom = 1),
            u.removeChild(d),
            (l = p = d = null),
            f.extend(b, j));
        }),
    ...
    data: function (a, c, d, e) {
      if (f.acceptData(a)) {
        ...
        return (
          ...
          o && !h[c]
            ? g.events
            : (k ? null == (i = h[c]) && (i = h[f.camelCase(c)]) : (i = h), i)
        );
      }
    },
      ...
      if (f.acceptData(a)) {
        ...
        if (b && (d = c ? j[k] : j[k].data)) {
          f.isArray(b) ||
            (b in d
              ? (b = [b])
              : (b = (b = f.camelCase(b)) in d ? [b] : b.split(" ")));
      ...
      data: function (a, c) {
        ...
        if (a === b) {
          if (
            ...
            for (i = (g = j.attributes).length; k < i; k++)
              0 === (h = g[k].name).indexOf("data-") &&
          ...
          : (((d = a.split(".", 2))[1] = d[1] ? "." + d[1] : ""),
            ...
            f.access(
              ...
              function (c) {
                if (c === b)
                  return (
                    (m = this.triggerHandler("getData" + e, [d[0]])) === b &&
                      j &&
        ...
        for (b = a.split(p), c = 0, d = this.length; c < d; c++)
          if (1 === (e = this[c]).nodeType)
            if (e.className || 1 !== b.length) {
              for (g = " " + e.className + " ", h = 0, i = b.length; h < i; h++)
                ~g.indexOf(" " + b[h] + " ") || (g += b[h] + " ");
        ...
        ? ((e = f.isFunction(a)),
          this.each(function (d) {
            var h,
              g = f(this);
            1 === this.nodeType &&
              (null == (h = e ? a.call(this, d, g.val()) : a)
                ? (h = "")
                : "number" == typeof h
                ? (h += "")
                : f.isArray(h) &&
    ...
    f.extend({
      ...
      removeAttr: function (a, b) {
        var c,
          ...
          i = 0;
        if (b && 1 === a.nodeType)
          for (g = (d = b.toLowerCase().split(p)).length; i < g; i++)
            (e = d[i]) &&
              ((c = f.propFix[e] || e),
              (h = u.test(e)) || f.attr(a, e, ""),
      ...
      prop: function (a, c, d) {
        ...
        if (a && 3 !== i && 8 !== i && 2 !== i)
          return (
            (1 !== i || !f.isXMLDoc(a)) &&
              ((c = f.propFix[c] || c), (g = f.propHooks[c])),
            d !== b
  ...
  (f.event = {
    add: function (a, c, d, e, g) {
      ...
      if (3 !== a.nodeType && 8 !== a.nodeType && c && d && (h = f._data(a))) {
        for (
          d.handler && ((d = (p = d).handler), (g = p.selector)),
            d.guid || (d.guid = f.guid++),
            (j = h.events) || (h.events = j = {}),
            (i = h.handle) ||
              ((h.handle = i =
                function (a) {
          ...
          (m = (l = A.exec(c[k]) || [])[1]),
            ...
            (r = j[m]) ||
              (((r = j[m] = []).delegateCount = 0),
              (s.setup && !1 !== s.setup.call(a, e, n, i)) ||
                (a.addEventListener
      ...
      if (g && (o = g.events)) {
        for (b = f.trim(I(b || "")).split(" "), h = 0; h < b.length; h++)
          if (((j = k = (i = A.exec(b[h]) || [])[1]), (l = i[2]), j)) {
            for (
              p = f.event.special[j] || {},
                m = (r = o[(j = (d ? p.delegateType : p.bindType) || j)] || [])
                  .length,
                l = l
                  ? new RegExp(
                      "(^|\\.)" +
    ...
    trigger: function (c, d, e, g) {
      if (!e || (3 !== e.nodeType && 8 !== e.nodeType)) {
        ...
        if (
          ((c.result = b),
          c.target || (c.target = e),
          (d = null != d ? f.makeArray(d) : []).unshift(c),
          (p = f.event.special[h] || {}).trigger &&
            !1 === p.trigger.apply(e, d))
        )
          return;
        if (
        ...
        return (
          ...
          !g &&
            ...
            (!p._default || !1 === p._default.apply(e.ownerDocument, d)) &&
    ...
    dispatch: function (c) {
      ...
      if (
        ...
        !i.preDispatch || !1 !== i.preDispatch.call(this, c))
      ) {
        if (e && (!c.button || "click" !== c.type))
          for (
            (n = f(this)).context = this.ownerDocument || this, m = c.target;
            m != this;
            m = m.parentNode || this
          )
            if (!0 !== m.disabled) {
              for (p = {}, r = [], n[0] = m, k = 0; k < e; k++)
                p[(t = (s = d[k]).selector)] === b &&
                  (p[t] = s.quick ? H(m, s.quick) : n.is(t)),
                  p[t] && r.push(s);
              r.length && j.push({ elem: m, matches: r });
            }
        for (
          d.length > e && j.push({ elem: this, matches: d.slice(e) }), k = 0;
            ...
            (s = q.matches[l]),
              (h ||
                ...
                (o = (
                  ...
                  ((c.result = o),
                  !1 === o && (c.preventDefault(), c.stopPropagation())));
    ...
    mouseHooks: {
      ...
      filter: function (a, d) {
        ...
        return (
          null == a.pageX &&
            null != d.clientX &&
            ((f = (e = a.target.ownerDocument || c).documentElement),
            (g = e.body),
            (a.pageX =
              d.clientX +
    ...
    f.fn.extend({
      on: function (a, c, d, e, g) {
        var h, i;
        if ("object" == typeof a) {
          for (i in ("string" != typeof c && ((d = d || c), (c = b)), a))
            this.on(i, c, d, a[i], g);
          return this;
        }
        if (
    ...
    (function () {
      ...
      var m = function (b, d, e, f) {
        ...
        do {
          if (
            (a.exec(""), (i = a.exec(x)) && ((x = i[3]), w.push(i[1]), i[2]))
          ) {
            l = i[3];
            break;
          }
      ...
      var n = (m.getText = function (a) {
        ...
        o = (m.selectors = {
          ...
          find: {
            ...
            TAG: function (a, b) {
              if (void 0 !== b.getElementsByTagName)
            ...
            CHILD: function (a, b) {
              ...
              switch (k) {
                ...
                case "nth":
                  ...
                  if (
                    ((f = b[0]),
                    (g = a.parentNode) && (g[d] !== f || !a.nodeIndex))
                  ) {
          ...
          if (
            ...
            o.order.splice(1, 0, "CLASS"),
              (o.find.CLASS = function (a, b, c) {
                if (void 0 !== b.getElementsByClassName && !c)
  ...
  f.fn.extend({
    ...
    f.extend({
      ...
      dir: function (a, c, d) {
        for (
          var e = [], g = a[c];
          g && 9 !== g.nodeType && (d === b || 1 !== g.nodeType || !f(g).is(d));
            ...
            (g =
              ...
              (h = (e =
                ...
                i.childNodes.length === this.length
                  ? { fragment: i }
                  : f.buildFragment(a, this, k)).fragment).childNodes.length
                ? (h = h.firstChild)
                : h.firstChild))
          ) {
            c = c && f.nodeName(g, "tr");
    ...
    f.extend({
      ...
      css: function (a, c, d) {
        ...
        return (
          (c = f.camelCase(c)),
          (g = f.cssHooks[c]),
          "cssFloat" === (c = f.cssProps[c] || c) && (c = "float"),
      ...
      swap: function (a, b, c) {
        ...
        for (f in ((e = c.call(a)), b)) a.style[f] = d[f];
        return e;
      },
    }),
    (f.curCSS = f.css),
  ...
  try {
    ...
    ((bU = c.createElement("a")).href = ""), (bU = bU.href);
  }
    ...
    f.each(["get", "post"], function (a, c) {
      f[c] = function (a, d, e, g) {
        return (
          ...
          f.ajax({ type: c, url: a, data: d, success: e, dataType: g })
        );
      };
    }),
    f.extend({
      ...
      ajax: function (a, c) {
                    ...
                    for (g = 1; g < i; g++) {
                      ...
                      if (((l = k), "*" === (k = d[g]))) k = l;
                        ...
                        !n &&
                          !p &&
                          f.error(
                            "No conversion from " + m.replace(" ", " to ")
                          ),
                          !0 !== n && (c = n ? n(c) : p(o(c)));
                      }
                    }
        ...
        if (d.beforeSend && (!1 === d.beforeSend.call(e, v, d) || 2 === s))
          return v.abort(), !1;
  ...
  f.ajaxSetup({
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (
        "jsonp" === b.dataTypes[0] ||
        (!1 !== b.jsonp && (cd.test(b.url) || (e && cd.test(b.data))))
      ) {
        var g,
    ...
    f.ajaxTransport("script", function (a) {
      if (a.crossDomain) {
        ...
        return {
          send: function (f, g) {
            ((d = c.createElement("script")).async = "async"),
  ...
  f.fn.extend({
    show: function (a, b, c) {
      ...
      for (g = 0; g < h; g++)
        (d = this[g]).style &&
          (("" !== (e = d.style.display) && "none" !== e) ||
            (d.style.display = f._data(d, "olddisplay") || ""));
      return this;
    },
    hide: function (a, b, c) {
      if (a || 0 === a) return this.animate(ct("hide", 3), a, b, c);
      for (var d, e, g = 0, h = this.length; g < h; g++)
        (d = this[g]).style &&
          "none" !== (e = f.css(d, "display")) &&
          !f._data(d, "olddisplay") &&
    ...
    animate: function (a, b, c, d) {
      function g() {
        ...
        for (i in ((b.animatedProperties = {}), a))
          if (
            (i !== (g = f.camelCase(i)) && ((a[g] = a[i]), delete a[i]),
            (k = f.cssHooks[g]) && "expand" in k)
          )
            for (i in ((l = k.expand(a[g])), delete a[g], l))
              i in a || (a[i] = l[i]);
        for (g in a) {
          if (
            ((h = a[g]),
        ...
        for (i in (null != b.overflow && (this.style.overflow = "hidden"), a))
          (j = new f.fx(this, b, i)),
            (h = a[i]),
            cm.test(h)
              ? (q =
                ...
                ? (f._data(this, "toggle" + i, "show" === q ? "hide" : "show"),
                  j[q]())
                : j[h]()
              : ((m = cn.exec(h)),
                (n = j.cur()),
      ...
      return f.isEmptyObject(a)
        ...
        : ((a = f.extend({}, a)),
          !1 === e.queue ? this.each(g) : this.queue(e.queue, g));
    },
    stop: function (a, c, d) {
      return (
    ...
    (f.fx.prototype = {
      ...
      step: function (a) {
        ...
        if (a || e >= i.duration + this.startTime) {
          for (b in ((this.now = this.end),
          (this.pos = this.state = 1),
          this.update(),
          (i.animatedProperties[this.prop] = !0),
          i.animatedProperties))
            !0 !== i.animatedProperties[b] && (g = !1);
          if (g) {
            if (
              (null != i.overflow &&
    ...
    f.extend(f.fx, {
      tick: function () {
        for (var a, b = f.timers, c = 0; c < b.length; c++)
      ...
      ? function (a, b, c, d) {
          ...
          var g = b.body,
            ...
            l =
              ...
              g.scrollLeft;
          return { top: d.top + k - i, left: d.left + l - j };
        }
      : function (a, b, c) {
          for (
            var d,
    ...
    (f.offset = {
      ...
      setOffset: function (a, b, c) {
        ...
        var m,
          ...
          k = {},
          l = {};
        ("absolute" === d || "fixed" === d) && f.inArray("auto", [h, i]) > -1
          ? ((m = (l = e.position()).top), (n = l.left))
        ...
        (f.fn[c] = function (a) {
          return f.access(
            ...
            function (a, c, h) {
              var i, j, k, l;
              return f.isWindow(a)
                ? ((j = (i = a.document).documentElement[d]),
                  (f.support.boxModel && j) || (i.body && i.body[d]) || j)
                : 9 === a.nodeType
                ? (i = a.documentElement)[d] >= i[e]
                  ? i[d]
